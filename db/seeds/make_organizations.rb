...
orgs.each do |org|
  ...
  org_rec.update_attributes(org.slice(:description, :urls, :org_key))
  org_rec.save
...
# From make_users org_keys = ['cho_encore', 'youth_alive']
